...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for s_node_1 in node_a1.effnodes:
            for s_node_2 in node_a2.effnodes:
                if (s_node_1.symbol == s_node_2.symbol and
                        s_node_1.is_pos is not s_node_2.is_pos):
                    return True
        return False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for a_node_1 in node_s1.parents:
            for a_node_2 in node_s2.parents:
                if a_node_1 not in a_node_2.mutex:
                    return False
        return True
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            not_find_goal = True
            i = 0
            while i < len(self.s_levels) and not_find_goal:
...
if __name__ == '__main__':
    ...
    for level, nodeset in enumerate(pg.a_levels):
        for node in nodeset:
